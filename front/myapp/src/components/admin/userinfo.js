...
return <form onSubmit={handleSubmit(onSubmitUpdateUser)} className="align-center flex vertical center" >
 ...
 />
                ...
                <div className="flex2 margin-top--- align-center">
                    <input className='background my-account margin-top---' {...register("mail")} placeholder="Adresse E-mail" type="text" id="email" defaultValue={props.info.mail} />
                </div>
                ...
                <input className='background my-account align-center margin-top---' {...register("business_name")} placeholder="Entreprise" type="text" id="business" />
                <input className='background my-account align-center margin-top---' {...register("adress")} placeholder="Adresse" type="text" id="adress" defaultValue={props.info.adress} />
                ...
                <div className="flex2 margin-top--- align-center">
                    <input className='background my-account- margin-top---' {...register("code_postal")} placeholder="Code postal" type="text" id="code-postal" defaultValue={props.info.code_postal} />
